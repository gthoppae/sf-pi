...
export const SF_PI_REGISTRY: readonly SfPiExtension[] = [
  ...
  },
  {
    ...
    defaultEnabled: true,
    commands: ["/sf-browser"],
    tools: ["sf_browser_open_org","sf_browser_snapshot","sf_browser_click","sf_browser_fill","sf_browser_select","sf_browser_press","sf_browser_wait","sf_browser_capture_evidence"],
