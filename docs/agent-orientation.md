...
| [SF Guardrail](../extensions/sf-guardrail/)                       | core     | on        | Salesforce-aware safety hooks — file protection policies, dangerous-command gating, and org-aware confirmation for production deploys, apex runs, and data mutations | `/sf-guardrail`                  | _none_                                                                                                                                    | _none_                    | `session_start`, `session_tree`, `before_agent_start`, `tool_call`                                                                        | `extensions/sf-guardrail/index.ts`            |
...
| [SF Pi Manager](../extensions/sf-pi-manager/)                     | core     | always-on | Core manager — provides /sf-pi commands                                                                                                                              | `/sf-pi`                         | _none_                                                                                                                                    | _none_                    | `session_start`, `session_shutdown`                                                                                                       | `extensions/sf-pi-manager/index.ts`           |
...
| [SF Welcome](../extensions/sf-welcome/)                           | ui       | on        | Salesforce-branded splash screen with environment status, extension health, and community info                                                                       | `/sf-welcome`, `/sf-setup-fonts` | _none_                                                                                                                                    | _none_                    | `session_start`, `agent_start`, `tool_call`, `session_shutdown`                                                                           | `extensions/sf-welcome/index.ts`              |
