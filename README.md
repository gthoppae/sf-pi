...
`>=0.74.1`). Older pi runtimes are not supported; the shims in
...
| [SF Data 360](./extensions/sf-data360/)                          | agent-tool | on        | Data Cloud/Data 360 facade and direct REST helper — d360 search/examples/execute/runbook, d360_api, compact metadata discovery, readiness probe, and progressive-disclosure references                                                         |
...
sf-pi requires pi `>=0.74.1`, so supported installations honor the env
