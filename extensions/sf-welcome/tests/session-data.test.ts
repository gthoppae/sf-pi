 ...
 * - the display label should come from the session header cwd, not a lossy
 *   decode of Pi's hyphen-escaped directory name
 */
...
function writeSession(relativePath: string, cwd: string, mtime: Date): void {
